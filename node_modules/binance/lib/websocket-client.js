...
class WebsocketClient extends BaseWSClient_1.BaseWebsocketClient {
    ...
    connectPublic() {
        return [
            ...
            this.connect(websocket_util_1.WS_KEY_MAP.alpha),
        ];
    }
    /**
    ...
    sendWSAPIRequest(wsKey, operation, params, requestFlags) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.options.authPrivateConnectionsOnConnect &&
                (requestFlags === null || requestFlags === void 0 ? void 0 : requestFlags.authIsOptional) !== true) {
            ...
            // Sign, if needed
            const signedEvent = yield this.signWSAPIRequest(request, requestFlags);
            ...
            this.logger.trace(`sendWSAPIRequest(): sent "${operation}" event with promiseRef(${promiseRef})`, Object.assign(Object.assign({}, WS_LOGGER_CATEGORY), { wsKey }));
     ...
     */
    signWSAPIRequest(requestEvent, requestFlags) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!requestEvent.params || (requestFlags === null || requestFlags === void 0 ? void 0 : requestFlags.authIsOptional)) {
                return requestEvent;
            }
            /**
            ...
            if (signRequest || this.options.authPrivateRequestsIndividually) {
                ...
                const serialisedParams = (0, requestUtils_1.serialiseParams)(semiFinalRequestParams, strictParamValidation, encodeValues, filterUndefinedParams, sortProperties);
                let signature;
                const signKeyType = this.getSignKeyType();
                switch (signKeyType) {
                    case 'Ed25519':
                    case 'RSASSA-PKCS1-v1_5': {
                        signature = yield this.signMessage(serialisedParams, this.options.api_secret, 'base64', 'SHA-256');
                        break;
                    }
                    case 'HMAC': {
                        const signMethod = 'hex';
                        const signAlgorithm = 'SHA-256';
                        signature = yield this.signMessage(serialisedParams, this.options.api_secret, signMethod, signAlgorithm);
                        break;
                    }
                    case undefined: {
                        throw new Error('API secret missing, unable to sign WS API request without valid API keys.');
                    }
                    default: {
                        throw (0, typeGuards_1.neverGuard)(signKeyType, `Unhandled sign key type for WS API request signing: "${signKeyType}"`);
                    }
                }
    ...
    resolveEmittableEvents(wsKey, event) {
        ...
        try {
             ...
             *
             */
            const parsedEvent = (0, websocket_util_1.parseRawWsMessage)(event, this.options);
            /**
             *
    ...
    fetchMarginListenToken(params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { token, expirationTime } = yield this.restClientCache
                    .getSpotRestClient(this.getRestClientOptions(), this.options.requestOptions)
                    .getMarginListenToken(params);
                return { token, expirationTime };
            }
            catch (e) {
                this.logger.error('Failed to fetch margin listen token', Object.assign(Object.assign({}, WS_LOGGER_CATEGORY), { error: e }));
                throw e;
            }
        });
    }
        ...
        return __awaiter(this, arguments, void 0, function* (wsKey, market, context = {}) {
            ...
            try {
                switch (market) {
                    ...
                    case 'alpha':
                        throw new Error('Alpha WebSocket has no user data streams - market data only.');
                    default:
    ...
    subscribeEndpoint(endpoint, market) {
        ...
        const wsBaseEndpoints = {
            spot: isDemoTrading && !isTestnet
                ? 'wss://demo-stream.binance.com:9443'
                : isTestnet
                    ? 'wss://stream.testnet.binance.vision'
                    : 'wss://stream.binance.com:9443',
            crossMargin: isDemoTrading && !isTestnet
                ? 'wss://demo-stream.binance.com:9443'
                : isTestnet
                    ? 'wss://stream.testnet.binance.vision'
                    : 'wss://stream.binance.com:9443',
            isolatedMargin: isDemoTrading && !isTestnet
                ? 'wss://demo-stream.binance.com:9443'
                : isTestnet
                    ? 'wss://stream.testnet.binance.vision'
                    : 'wss://stream.binance.com:9443',
     ...
     */
    subscribeAlpha(topics) {
        const topicList = Array.isArray(topics) ? topics : [topics];
        return this.subscribe(topicList, websocket_util_1.WS_KEY_MAP.alpha);
    }
    /**
     * Subscribe to Alpha all tokens 24h ticker (came@allTokens@ticker24)
     */
    subscribeAlphaAllTokensTicker24() {
        return this.subscribe('came@allTokens@ticker24', websocket_util_1.WS_KEY_MAP.alpha);
    }
    /**
     * Subscribe to Alpha aggregate trades for a symbol
     * @param symbol e.g. ALPHA_474USDT
     */
    subscribeAlphaAggTrade(symbol) {
        const lowerCaseSymbol = symbol.toLowerCase();
        return this.subscribe(`${lowerCaseSymbol}@aggTrade`, websocket_util_1.WS_KEY_MAP.alpha);
    }
    /**
     ...
     */
    subscribeAlphaFulldepth(symbol, intervalMs = 500) {
        const lowerCaseSymbol = symbol.toLowerCase();
        return this.subscribe(`${lowerCaseSymbol}@fulldepth@${intervalMs}ms`, websocket_util_1.WS_KEY_MAP.alpha);
    }
    /**
     ...
     */
    subscribeAlphaKline(contractAddress, chainId, interval) {
        return this.subscribe(`came@${contractAddress}@${chainId}@kline_${interval}`, websocket_util_1.WS_KEY_MAP.alpha);
    }
    /**
